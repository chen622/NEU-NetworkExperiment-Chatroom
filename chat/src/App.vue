<template>
  <div id="app">
    ...
    <!--TopBar end-->
    <!--empty-->
    <md-empty-state class="empty-state md-primary" md-rounded md-icon="hourglass_empty" md-label="请畅所欲言" md-description="尚未打开任何聊天窗口." v-if="(!isGroup)&&(!isGod)"></md-empty-state>
    <!--empty end-->
    <!--CardContent-->
    <md-dialog-prompt
